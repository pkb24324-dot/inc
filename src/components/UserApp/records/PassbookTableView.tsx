        ...
        <table className="w-full text-left text-xs font-mono">
          <thead className={`text-[10px] uppercase tracking-wider border-b ${
            ...
            <tr>
              ...
              <th className="py-3 px-3.5 whitespace-nowrap">Reference / UTR</th>
            ...
            {transactions.map((txn) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Particulars */}
                  <td className="py-2.5 px-3.5 font-sans min-w-[180px]">
                  ...
                  <td className="py-2.5 px-3.5 text-center whitespace-nowrap">
                    <span className={`inline-flex items-center space-x-1 text-[10px] font-bold px-2 py-0.5 rounded-full capitalize ${
                      isSuccess
                  ...
                  <td className="py-2.5 px-3.5 text-right whitespace-nowrap">
                    <button 
                      onClick={() => onSelectTxn(txn)}
                      className="text-blue-600 dark:text-blue-400 hover:underline font-bold text-[11px] font-sans inline-flex items-center space-x-0.5"
                    >
                      <span>Slip</span>
